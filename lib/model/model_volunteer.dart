...
class Volunteer {
  ...
  factory Volunteer.fromJson(Map<String, dynamic> json) => Volunteer(
        data: List<DatumVolunteer>.from(json["data"].map((x) => DatumVolunteer.fromJson(x))),
        message: json["message"],
        status: json["status"],
      );
}

class DatumVolunteer {
  int id;
  String title;
  Category category;
  int categoryId;
  ...
  factory DatumVolunteer.fromJson(Map<String, dynamic> json) => DatumVolunteer(
              id: json["id"],
        title: json["title"],

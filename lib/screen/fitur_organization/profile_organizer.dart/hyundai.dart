...
class HyundaiProfileScreen extends StatefulWidget {
  const HyundaiProfileScreen({super.key});

  @override
  State<HyundaiProfileScreen> createState() => _HyundaiProfileScreenState();
}

class _HyundaiProfileScreenState extends State<HyundaiProfileScreen> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (news.data.isEmpty) {
              ...
              final datum2 = news.data[1]; // Ambil satu data pertama dari list
                          ...
                          Container(
                            ...
                            decoration:  BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(datum2.organizer.photoUrl),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),

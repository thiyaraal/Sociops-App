...
class SkilledUpProfileScreen extends StatefulWidget {
  const SkilledUpProfileScreen({super.key});

  @override
  State<SkilledUpProfileScreen> createState() => _SkilledUpProfileScreenState();
}

class _SkilledUpProfileScreenState extends State<SkilledUpProfileScreen> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (news.data.isEmpty) {
              ...
              final datum1 = news.data[0]; // Ambil satu data pertama dari list
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(datum1.organizer.photoUrl),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
